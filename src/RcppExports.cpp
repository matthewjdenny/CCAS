...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::vec >::type random_numbers(random_numbersSEXP);
    rcpp_result_gen = Rcpp::wrap(sttgp(token_topic_assignments, token_word_types, alpha_m, beta_n, number_of_documents, resample_word_types, random_numbers));
    return rcpp_result_gen;
END_RCPP
}
// mh_to_convergence
