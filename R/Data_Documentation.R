#' Department Manager Email dataset --  ComNet object
#'
#' An example dataset comprising 121 emails sent among 20 county government
#' department managers.
#'
#' @format A ComNet object.
"ComNet_data"

#' Department Manager Email dataset -- Example output from the ccas() function.
#'
#' Output from the example model run on county manager data..
#'
#' @format A CCAS object.
"Model_Output"
